...
@patch('database.database.psycopg2.connect')
...
def test_execute_query_with_params_success(mock_connect):
    ...
    database.execute_query("INSERT INTO test (a, b) VALUES (%s, %s);", (1, 2))
...
def test_execute_query_param_count_mismatch(mock_connect):
    ...
    with pytest.raises(ValueError):
        database.execute_query("INSERT INTO test (a, b) VALUES (%s, %s);", (1,))
